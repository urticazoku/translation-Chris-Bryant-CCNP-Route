...
Говоря о перерасчете таблиц маршрутизации по алгоритму SPF, можно видеть сколько раз он запускался с помощью команды **show ip ospf**. Если вы видите, что это число постоянно возрастает, то значит в зоне OSPF есть нестабильный сегмент. (Тут много текста в выводе команды, но его стоит знать).
